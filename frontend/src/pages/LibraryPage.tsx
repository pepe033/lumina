        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-slate-400 text-base mt-1">
              Przeglądaj swoją kolekcję zdjęć. Kliknij na dowolne zdjęcie aby rozpocząć edycję.
            </p>
          </div>
        </div>
      ...
      {!loading && photos.length === 0 && (
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-slate-400 text-lg text-center mb-6">
            Nie masz jeszcze żadnych zdjęć w bibliotece.
          </p>
          <button
            onClick={() => navigate('/upload')}
            className="px-6 py-3 bg-gradient-to-br from-blue-500 to-purple-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300"
          >
