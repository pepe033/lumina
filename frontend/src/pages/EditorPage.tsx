  ...
  const applyAdjustments = useCallback(() => {
    ...
    for (let i = 0; i < data.length; i += 4) {
      ...
      if (adjustments.filter === 'grayscale') {
        ...
        // Vintage: slight sepia + reduced saturation + vignette effect
        const tr = 0.393 * r + 0.769 * g + 0.189 * b;
        const tg = 0.349 * r + 0.686 * g + 0.168 * b;
        const tb = 0.272 * r + 0.534 * g + 0.131 * b;
        r = tr * 0.8;
    ...
    // Create temporary canvas with adjusted colors
  ...
  return (
    <div className="h-full flex flex-col space-y-6">
      ...
      <div className="flex flex-1 gap-6 overflow-hidden">
        ...
        <div className="w-80 flex-shrink-0 bg-slate-800/50 backdrop-blur-xl rounded-2xl border border-slate-700/50 p-6 shadow-2xl overflow-y-auto">
          <div className="space-y-6">
              ...
              <div className="space-y-3">
                <div className="bg-slate-900/50 rounded-xl p-3 border border-slate-700/50">
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-xs font-medium text-slate-300">Jasność</label>
                    <span className="text-xs font-bold text-blue-400 min-w-[3ch] text-right">{adjustments.brightness}</span>
                  </div>
                  <input
                    type="range"
                    min="-100"
                ...
                <div className="bg-slate-900/50 rounded-xl p-3 border border-slate-700/50">
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-xs font-medium text-slate-300">Kontrast</label>
                    <span className="text-xs font-bold text-blue-400 min-w-[3ch] text-right">{adjustments.contrast}</span>
                  </div>
                  <input
                    type="range"
                    min="-100"
                ...
                <div className="bg-slate-900/50 rounded-xl p-3 border border-slate-700/50">
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-xs font-medium text-slate-300">Nasycenie</label>
                    <span className="text-xs font-bold text-blue-400 min-w-[3ch] text-right">{adjustments.saturation}</span>
                  </div>
                  <input
                    type="range"
                    min="-100"
            ...
            <div>
              ...
              <div className="space-y-3">
                ...
                <div className="bg-slate-900/50 rounded-xl p-3 border border-slate-700/50">
                  <div className="flex justify-between items-center mb-2">
                    <label className="text-xs font-medium text-slate-300">Precyzyjny obrót</label>
                    <span className="text-xs font-bold text-orange-400 min-w-[4ch] text-right">{adjustments.rotation}°</span>
                  </div>
                  <input
                    type="range"
                    min="-180"
        ...
        {/* Main editing area */}
        <div className="flex-1 bg-slate-800/30 rounded-2xl border border-slate-700/50 flex items-center justify-center p-6 overflow-auto">
          <div className="bg-slate-900/50 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-700/50 p-6 relative">
            <canvas
